    ...
    class Margin < BaseModel
      ...
      class << self
        ...
        def calculate_multi(params)
          formatted_params = camelize_keys(params)
          formatted_params["scripList"] = formatted_params["scripList"]&.map { |h| h.is_a?(Hash) ? camelize_keys(h) : h } if formatted_params["scripList"].is_a?(Array)
          validate_params!(formatted_params, DhanHQ::Contracts::MultiScripMarginCalcRequestContract)
